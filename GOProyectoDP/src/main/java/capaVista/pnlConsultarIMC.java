 ...
 * @author georg
 */
public class pnlConsultarIMC extends javax.swing.JPanel {

    /**
     * Creates new form pnlConsultarIMC
     */
    public pnlConsultarIMC() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consultar IMC");

        jPanel2.setBackground(new java.awt.Color(255, 255, 255));
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Busqueda de IMC por ID", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 18))); // NOI18N
    ...
    public void mostrarIMC(Usuario usuario, double imc) {
        ...
        if (usuario != null) {
            // Agregar fila con ID, Nombre y el IMC
            model.addRow(new Object[] {
                usuario.getId(),          // ID del usuario
                usuario.getNombre(),      // Nombre del usuario
                String.format("%.2f", imc) // IMC calculado
            });
        } else {
            JOptionPane.showMessageDialog(this, "No se encontró el usuario con ID: " + usuario.getId(), "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    private void btnConfirmarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmarActionPerformed
        ...
        // Crear el comando para buscar el IMC
        Command buscarIMCCommand = new BuscarIMCCommand(id, controlFacade, this);
        
        // Ejecutar el comando
        buscarIMCCommand.execute();
